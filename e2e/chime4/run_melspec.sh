...
et05_real_beamformit_2mics et05_simu_beamformit_2mics \
et05_real_beamformit_5mics et05_simu_beamformit_5mics \
"
...
train_set_temp1=tr05_real_noisy_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
train_set_temp2=tr05_simu_noisy_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
train_set_temp3=train_si284_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    temp=tr05_multi_noisy_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
    temp_dev1=dt05_simu_isolated_1ch_track_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
    temp_dev2=dt05_real_isolated_1ch_track_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
