...
#recog_set_ori="dt_real_8ch_beamformit et_real_8ch_beamformit dt_real_1ch dt_simu_1ch dt_real_1ch_wpe dt_simu_1ch_wpe et_real_1ch_wpe et_simu_1ch_wpe"
recog_set_ori="et_real_8ch_beamformit dt_real_1ch dt_simu_1ch et_real_1ch et_real_1ch_wpe et_simu_1ch_wpe"
#recog_set_ori="et_real_1ch"
...
if $no_norm; then
  train_set=${train_set_ori}_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append}
  train_dev=${train_dev_ori}_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append}
  train_set_temp1=tr_simu_8ch_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append}
  train_set_temp2=train_si284_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append}
  recog_set=""
  ...
  for s in $recog_set_ori; do
    s_append=${s}_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append}
    recog_set="$recog_set ${s_append}"
    [ ! -d data/${s_append} ] && ./utils/copy_data_dir.sh data/$s data/${s_append}
  done
else
  train_set=${train_set_ori}_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
  train_dev=${train_dev_ori}_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
  train_set_temp1=tr_simu_8ch_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
  train_set_temp2=train_si284_nf${nfilters}_nfft${nfft}_frate${frate}_${append}
  recog_set=""
  [ ! -d data/$train_set_temp1 ] && ./utils/copy_data_dir.sh data/tr_simu_8ch data/$train_set_temp1
  [ ! -d data/$train_set_temp2 ] && ./utils/copy_data_dir.sh data/train_si284 data/$train_set_temp2
  for s in $recog_set_ori; do 
    s_append=${s}_nf${nfilters}_nfft${nfft}_frate${frate}_${append} 
    recog_set="$recog_set ${s_append}"
    [ ! -d data/${s_append} ] && ./utils/copy_data_dir.sh data/$s data/${s_append}
  done
fi
...
if $no_norm; then
    dumpdir=dump_fbank_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append}
    fbankdir=fbank_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append}
  else
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    if $no_norm; then
        utils/combine_data.sh data-fbank/${train_dev} \
          data-fbank/dt_real_1ch_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append} \
          data-fbank/dt_simu_1ch_nf${nfilters}_nfft${nfft}_frate${frate}_nonorm_${append} 
      else
        utils/combine_data.sh data-fbank/${train_dev} \
