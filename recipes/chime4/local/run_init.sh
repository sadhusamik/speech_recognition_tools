...
if [ $stage -le 0 ]; then
  ...
  local_pyspeech/simplify_dictionary.sh data/local/dict conf/phone_map_wsj
  utils/prepare_lang.sh --position_dependent_phones false data/local/dict "<SPOKEN_NOISE>" data/local/lang_tmp data/lang
